...
export type ScheduledTripRequestDepartureDayEnum =
  (typeof ScheduledTripRequestDepartureDayEnum)[keyof typeof ScheduledTripRequestDepartureDayEnum];

/**
 * Check if a given object implements the ScheduledTripRequest interface.
 */
export function instanceOfScheduledTripRequest(
  value: object,
): value is ScheduledTripRequest {
  ...
  if (!('destination' in value) || value['destination'] === undefined)
    return false;
  if (!('departureTime' in value) || value['departureTime'] === undefined)
    return false;
  if (!('departureDay' in value) || value['departureDay'] === undefined)
    return false;
...
export function ScheduledTripRequestFromJSONTyped(
  json: any,
...
export function ScheduledTripRequestToJSONTyped(
  value?: ScheduledTripRequest | null,
