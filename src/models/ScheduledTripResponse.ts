 ...
 */
export function instanceOfScheduledTripResponse(
  value: object,
): value is ScheduledTripResponse {
  ...
  if (
    ...
    return false;
  if (!('arrivalDateTime' in value) || value['arrivalDateTime'] === undefined)
    return false;
  if (!('availableSeats' in value) || value['availableSeats'] === undefined)
    return false;
  if (!('priceCzk' in value) || value['priceCzk'] === undefined) return false;
  return true;
}

export function ScheduledTripResponseFromJSON(
  json: any,
): ScheduledTripResponse {
  return ScheduledTripResponseFromJSONTyped(json, false);
}

export function ScheduledTripResponseFromJSONTyped(
  json: any,
...
export function ScheduledTripResponseToJSONTyped(
  value?: ScheduledTripResponse | null,
