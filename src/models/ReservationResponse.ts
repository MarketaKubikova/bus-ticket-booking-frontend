...
export type ReservationResponseStatusEnum =
  (typeof ReservationResponseStatusEnum)[keyof typeof ReservationResponseStatusEnum];
...
export type ReservationResponseTariffEnum =
  (typeof ReservationResponseTariffEnum)[keyof typeof ReservationResponseTariffEnum];

/**
 * Check if a given object implements the ReservationResponse interface.
 */
export function instanceOfReservationResponse(
  value: object,
  ...
  if (!('destination' in value) || value['destination'] === undefined)
    return false;
  if (
    !('departureDateTime' in value) ||
    value['departureDateTime'] === undefined
  )
    return false;
  if (!('seatNumber' in value) || value['seatNumber'] === undefined)
    return false;
  if (!('passengerEmail' in value) || value['passengerEmail'] === undefined)
    return false;
...
export function ReservationResponseFromJSONTyped(
  json: any,
...
export function ReservationResponseToJSONTyped(
  value?: ReservationResponse | null,
