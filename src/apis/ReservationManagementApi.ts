...
import type { ReservationRequest, ReservationResponse } from '../models/index';
import {
...
export class ReservationManagementApi extends runtime.BaseAPI {
  ...
  async createReservationRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ReservationResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ReservationResponseFromJSON(jsonValue),
    );
  }
   ...
   */
  async getUsersReservationsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ReservationResponse<any>>> {
    const queryParameters: any = {};
  ...
  async getUsersReservations(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ReservationResponse<any>> {
