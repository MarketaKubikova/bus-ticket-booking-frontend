...
import type { BusRequest, BusResponse } from '../models/index';
import {
  BusRequestFromJSON,
  BusRequestToJSON,
  BusResponseFromJSON,
...
export class BusManagementApi extends runtime.BaseAPI {
   ...
   */
  async createBusRaw(
    requestParameters: CreateBusRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BusResponse>> {
   ...
   * Get all buses
   */
  async getAllBusesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BusResponse<any>>> {
    const queryParameters: any = {};
   ...
   */
  async getBusByIdRaw(
    requestParameters: GetBusByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<BusResponse>> {
