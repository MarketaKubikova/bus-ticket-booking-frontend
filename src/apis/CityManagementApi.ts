...
import type { CityRequest, CityResponse } from '../models/index';
import {
  CityRequestFromJSON,
  CityRequestToJSON,
...
export class CityManagementApi extends runtime.BaseAPI {
   ...
   */
  async createCityRaw(
    requestParameters: CreateCityRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CityResponse>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CityResponseFromJSON(jsonValue),
    );
  }
   ...
   * Get all cities
   */
  async getAllCitiesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CityResponse<any>>> {
    const queryParameters: any = {};
