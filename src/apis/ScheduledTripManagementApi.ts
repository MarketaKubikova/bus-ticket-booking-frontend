...
export class ScheduledTripManagementApi extends runtime.BaseAPI {
   ...
   */
  async createScheduledTripRaw(
    requestParameters: CreateScheduledTripRequest,
    ...
    const response = await this.request(
      {
        ...
        body: ScheduledTripRequestToJSON(
          requestParameters['scheduledTripRequest'],
        ),
      },
      initOverrides,
    );
   ...
   * Create Scheduled Trip
   */
  async createScheduledTrip(
    requestParameters: CreateScheduledTripRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<string> {
    const response = await this.createScheduledTripRaw(
      requestParameters,
      initOverrides,
    );
   ...
   */
  async searchScheduledTripsRaw(
    requestParameters: SearchScheduledTripsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ScheduledTripResponse<any>>> {
   ...
   * Search Scheduled Trips
   */
  async searchScheduledTrips(
    requestParameters: SearchScheduledTripsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ScheduledTripResponse<any>> {
    const response = await this.searchScheduledTripsRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
